const quizData = [
    {
        ...
        options: ['A programming launguage', 'A collection of algorithms', 'A way to store and organize data', 'A type of computer hardware'],
        answer: 'A way to store and organize data',
    },
    {
        question: 'Which data structure is use for implementing recursion?',
